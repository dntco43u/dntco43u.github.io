---
date: 2025-12-15
title: promocode-helper
description: 화면 코드 클립보드 복사 매크로
tags:
  - autohotkey
categories:
  - dev
...
## GitHub repository
[바로 가기](https://github.com/dntco43u/promocode_helper)
...
| `Ctrl+Shift+R` | Reload           |
| `Ctrl+Shift+X` | Exit             |
| `Ctrl+Shift++` | getPixelColor    |
| `Ctrl+Shift+A` | 코드 캡처 (자동) |
| `Ctrl+Shift+S` | 코드 캡처 (수동) |
| `Ctrl+Shift+D` | 마우스 캡처      |

### promocode_helper.properties
코드 배경색/좌표 구성
```ini
CODE_JUDGE_BG_COLOR=0xFFFFFC
CODE_JUDGE_X=622
CODE_JUDGE_Y=885
CODE_START_X=619
CODE_START_Y=970
...
[^1]: https://github.com/dntco43u/promocode_helper/blob/main/promocode_helper.ahk
